...
MTriangle::MTriangle(const glm::vec2 &_p1, const glm::vec2 &_p2, const glm::vec2 &_p3)
	:	p1(_p1), p2(_p2), p3(_p3),
	e1(_p1, _p2), e2(_p2, _p3), e3(_p3, _p1)
{}
	
bool MTriangle::ContainsVertex(const glm::vec2 &v) {
	return p1 == v || p2 == v || p3 == v; 
}
		
bool MTriangle::CircumCircleContains(const glm::vec2 &v) {
